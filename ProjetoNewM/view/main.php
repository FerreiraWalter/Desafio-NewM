...
<form method="post" action="">
    <div class="grid justify-items-center text-gray-600 pt-10 pb-6">
        <input type="search" name="search" placeholder="Search" class="bg-white h-10 px-5 pr-10 rounded-full text-sm
    focus:outline-none">
        <button class="bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex
    items-center justify-center">Pesquisar</button>
    </div>
</form>
